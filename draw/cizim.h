...
static void __fastcall DrawRectImGui(int x, int y, int w, int h, RGBA color, int thickness)
{
...
static void __fastcall ExternDrawLineImGui(int x1, int y1, int x2, int y2, RGBA color, int thickness)
{
	if (x2 != 0 && y2 != 0)
	{
...
static void __fastcall ExternDrawFilledRectImGui(int x, int y, int w, int h, RGBA color)
{
	ImGui::GetOverlayDrawList()->AddRectFilled(ImVec2(x, y), ImVec2(x + w, y + h), ImGui::ColorConvertFloat4ToU32(ImVec4(color.R / 255.0, color.G / 255.0, color.B / 255.0, color.A / 255.0)), 0, 0);
}
static void __fastcall ExternDrawCornerBoxImGui(int x, int y, int w, int h, int borderPx, RGBA color)
{
...
static std::string __fastcall UnicodeToUTF8(unsigned int codepoint)
{
	std::string out;
...
static std::string __fastcall string_To_UTF8(const std::string& str)
{
...
static void __fastcall DrawFilledRectImGui(int x, int y, int w, int h, RGBA color)
{
	ImGui::GetOverlayDrawList()->AddRectFilled(ImVec2(x, y), ImVec2(x + w, y + h), ImGui::ColorConvertFloat4ToU32(ImVec4(color.R / 255.0, color.G / 255.0, color.B / 255.0, color.A / 255.0)), 0, 0);
}
static void __fastcall DrawNewTextImGui(int x, int y, RGBA color, const char* str)
{
	if (x != 0 && y != 0)
	{
...
static void __fastcall DrawNewTextImGuiInt(int x, int y, RGBA color, int str)
{
	if (x != 0 && y != 0)
	{
...
static void __fastcall DrawShadowTextImGui(int x, int y, RGBA color, const char* str)
{
	if (x != 0 && y != 0)
	{
		ImFont a;
...
//	ImGui::GetOverlayDrawList()->AddRect(ImVec2(x, y), ImVec2(x + w, y + h), ImGui::ColorConvertFloat4ToU32(ImVec4(color.R / 255.0, color.G / 255.0, color.B / 255.0, color.A / 255.0)), 0, 0, thickness);
//}
static void __fastcall RectFilledImGui(int x0, int y0, int x1, int y1, ImColor color, float rounding, int rounding_corners_flags)
{
	ImGui::GetWindowDrawList()->AddRectFilled(ImVec2(x0, y0), ImVec2(x1, y1), color, rounding, rounding_corners_flags);
}
static void __fastcall DrawCircleFilledImGui(int x, int y, int radius, RGBA color, int segments)
{
...
static void __fastcall DrawTriangleFilledImGui(int x1, int y1, int x2, int y2, int x3, int y3, RGBA color)
{
...
static void __fastcall DrawLineImGui(int x1, int y1, int x2, int y2, RGBA color, int thickness)
{
	if (x2 != 0 && y2 != 0)
	{
		ImGui::GetOverlayDrawList()->AddLine(ImVec2(x1, y1), ImVec2(x2, y2), ImGui::ColorConvertFloat4ToU32(ImVec4(color.R / 255.0, color.G / 255.0, color.B / 255.0, color.A / 255.0)), thickness);
...
static void __fastcall DrawBoxImGui(int x1, int y1, int bx, int by, RGBA color, int thickness)
{
...
static void __fastcall DrawBottomHealthImGui(int x, int y, int w, int h, int borderPx, RGBA color)
{
...
static void __fastcall DrawBottomHealth2ImGui(int x, int y, RGBA color, int value) //by exploder
{
	int width = 60;
	int height = 8;
	int pad = 1;
...
static void __fastcall DrawCornerBoxImGui(int x, int y, int w, int h, int borderPx, RGBA color)
{
...
static void __fastcall DrawNormalBoxImGui(int x, int y, int w, int h, int borderPx, RGBA color)
{
...
static void __fastcall DrawFilledBoxImGui(int x, int y, int w, int h, int borderPx, RGBA color)
{
	DrawFilledRectImGui(x + borderPx, y, w, borderPx, color); //top 
	DrawFilledRectImGui(x + w - w + borderPx, y, w, borderPx, color); //top 
	DrawFilledRectImGui(x, y, borderPx, h, color); //left 
...
static void __fastcall ExternDrawNewTextImGui(int x, int y, RGBA color, const char* str)
{
	if (x != 0 && y != 0)
	{
